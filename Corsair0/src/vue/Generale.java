...
public class Generale extends JFrame 
{
	...
	private static PanelHebergement unPanelHebergement= new PanelHebergement(); 
	...
	public static void setVisibleHebergement(boolean action)
	{
		Generale.unPanelHebergement.setVisible(action);
	}
