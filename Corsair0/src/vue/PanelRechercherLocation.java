...
public class PanelRechercherLocation extends PanelCentral implements ActionListener 
{
	...
	public PanelRechercherLocation() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			String mot = this.txtMot.getText(); 
			this.uneTable = new JTable(Corsair.getDonnees(Corsair.findAllLocations(mot)), entetes); 
