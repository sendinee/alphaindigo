...
public class PanelRechercherUser extends PanelCentral implements ActionListener 
{
	...
	private String Location [] = {"iduser", "login", "mdp"};
	
	public PanelRechercherUser() {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == this.btOk)
		{
			...
			this.uneTable = new JTable(Corsair.getDonnees(Corsair.findAllUsers(mot)), Location);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			String mot = this.txtMot.getText(); 
			this.uneTable = new JTable(Corsair.getDonnees(Corsair.findAllUsers(mot)), entetes); 
