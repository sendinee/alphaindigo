...
public class PanelRechercherVol extends PanelCentral implements ActionListener 
{
	...
	public void actionPerformed(ActionEvent e) {
		...
		if(e.getSource() == this.btOk)
		{
			...
			this.uneTable = new JTable(Corsair.getDonnees(Corsair.findAllVols(mot)), Location);
	...
	public void actionPerformed(ActionEvent e) {
		...
		{
			String mot = this.txtMot.getText(); 
			this.uneTable = new JTable(Corsair.getDonnees(Corsair.findAllVols(mot)), entetes); 
